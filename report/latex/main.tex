...
\label{listing:ShipModel} 
\lstinputlisting[label=code:hello]{../../core/src/main/java/ru/spbstu/icc/kspt/inspace/model/fleet/ShipModel.java}
\parindent=0.6cm
...
\captionof{lstlisting}{ActionNodeFactory.java}
\label{listing:ActionNodeFactory} 
\lstinputlisting[label=code:hello]{../../app/src/main/java/ru/spbstu/icc/kspt/inspace/app/ActionNodeFactory.java}
\parindent=0.6cm


\captionof{lstlisting}{GalaxyNodeFactory.java}
\label{listing:GalaxyNodeFactory} 
\lstinputlisting[label=code:hello]{../../app/src/main/java/ru/spbstu/icc/kspt/inspace/app/GalaxyNodeFactory.java}
\parindent=0.6cm



\captionof{lstlisting}{MissionDialogsFactory.java}
\label{listing:MissionDialogsFactory} 
\lstinputlisting[label=code:hello]{../../app/src/main/java/ru/spbstu/icc/kspt/inspace/app/MissionDialogsFactory.java}
\parindent=0.6cm


\captionof{lstlisting}{ObjectsNodeFactory.java}
\label{listing:ObjectsNodeFactory} 
\lstinputlisting[label=code:hello]{../../app/src/main/java/ru/spbstu/icc/kspt/inspace/app/ObjectsNodeFactory.java}
\parindent=0.6cm


\captionof{lstlisting}{OverviewNodeFactory.java}
\label{listing:OverviewNodeFactory} 
\lstinputlisting[label=code:hello]{../../app/src/main/java/ru/spbstu/icc/kspt/inspace/app/OverviewNodeFactory.java}
\parindent=0.6cm

\captionof{lstlisting}{InSpace.java}
\label{listing:InSpace} 
\lstinputlisting[label=code:hello]{../../app/src/main/java/ru/spbstu/icc/kspt/inspace/app/InSpace.java}
\parindent=0.6cm
